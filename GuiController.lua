...
local SoundService = script.Parent.Parent.Parent.Parent.SoundService
...
local hasCoreGuiAccess,_ = pcall(function()
	return game.CoreGui:GetFullName()
end)
local player = Players.LocalPlayer
local playerGui = hasCoreGuiAccess and (gethui ~= nil and gethui() or game.CoreGui) or player.PlayerGui
